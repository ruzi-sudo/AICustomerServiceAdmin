...
export { sysLoginLogs, sysSystemLogs, sysSystemLogDetails, sysOnlineUsers, sysMineLogs } from './logs';
...
import type { sysLoginLogs, sysSystemLogs, sysOnlineUsers, sysMineLogs } from './logs';
